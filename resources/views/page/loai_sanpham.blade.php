		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{route('trang-chu')}}">Trang Chủ</a> / <span>Sản phẩm {{$loai_sp->name}}</span>
				</div>
			</div>
					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Tìm thấy <strong>{{count($sp_theoloai)}}</strong> sản phẩm </p>
								<div class="clearfix"></div>
							</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp->id)}}"><img src="xuanngoc/Image/product/{{$sp->image}}" alt="" height="250px"></a>
										</div>
						...
						<div class="beta-products-list">
							<h4>Sản Phẩm Khác</h4>
							<div class="beta-products-details">
								<p class="pull-left">Tìm thấy <strong> {{count($sp_khac)}}</strong> sản phẩm</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
												...
												@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp_k->id)}}"><img src="xuanngoc/Image/product/{{$sp_k->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
